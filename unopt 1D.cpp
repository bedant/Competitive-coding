...
int main()
{
    int t,n,i,j,k,l,cnt,r,high,low,mid,w,m,term,b,x,sum=0,check=1,lft_lsorted[100000],rt_lsorted[100000];
    cin>>t;
    f(w,t)
    {
        int flag=0;
        ...
        //f(i,n)
        {
            //cout<<lft_lsorted[i]<<"   "<<rt_lsorted[i]<<endl;
        }
        cout<<cnt<<endl;
    }
}
